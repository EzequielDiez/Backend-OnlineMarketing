...
class ProductManager {
  ...
  getProducts() {
    ...
    if (fs.existsSync(this.path)) {
      products = JSON.parse(fs.readFileSync(this.path, 'utf8'));
    }
...
const productId3 = productManager.addProduct(product3);
console.log(`Producto agregado con id ${productId3}`);

// Obtener un producto por id
console.log('Obteniendo producto por id...');
const product = productManager.getProductById(productId2);
console.log(`Producto obtenido:`, product);

// Actualizar un producto
console.log('Actualizando producto...');
const updatedProduct = { price: 7000 };
const updated = productManager.updateProduct(productId2, updatedProduct);
if (updated) {
...
const deleted = productManager.deleteProduct(productId1);
if (deleted) {
